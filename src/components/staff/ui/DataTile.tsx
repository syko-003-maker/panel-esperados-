...
const TONE_STYLES: Record<Tone, {
  ...
  default: {
    ...
    hoverShadow: "0 0 0 1px rgba(255,255,255,0.18), 0 0 32px -4px rgba(255,255,255,0.10), 0 18px 38px -10px hsl(var(--sunset-surface2)/0.6)",
  },
  success: {
    ...
    hoverShadow: "0 0 0 1px rgba(16,185,129,0.45), 0 0 28px 0 rgba(16,185,129,0.30), 0 0 56px 4px rgba(16,185,129,0.18), 0 18px 38px -10px hsl(var(--sunset-surface2)/0.6)",
  },
  warning: {
    ...
    hoverShadow: "0 0 0 1px rgba(251,191,36,0.50), 0 0 28px 0 rgba(251,191,36,0.32), 0 0 60px 4px rgba(245,158,11,0.22), 0 18px 38px -10px hsl(var(--sunset-surface2)/0.6)",
  },
  danger: {
    ...
    hoverShadow: "0 0 0 1px rgba(239,68,68,0.48), 0 0 28px 0 rgba(239,68,68,0.30), 0 0 56px 4px rgba(220,38,38,0.18), 0 18px 38px -10px hsl(var(--sunset-surface2)/0.6)",
  },
  info: {
    ring: "border-[hsl(var(--sunset-magenta))]/40 bg-[hsl(var(--sunset-magenta))]/[0.16]",
    value: "text-rose-50",
    label: "text-rose-300/70",
    bar: "from-transparent via-[#c93a52]/80 to-transparent",
    glow: "hsl(var(--sunset-magenta)/0.32)",
    hoverShadow: "0 0 0 1px rgba(220,60,90,0.50), 0 0 28px 0 rgba(220,60,90,0.30), 0 0 56px 4px hsl(var(--sunset-magenta)/0.20), 0 18px 38px -10px hsl(var(--sunset-surface2)/0.6)",
  },
};
...
export function DataTile({
  ...
  return (
    <div
      className={cn(
        "app-card data-tile group relative flex h-full flex-col overflow-hidden rounded-2xl border px-4 py-3.5 shadow-[0_14px_32px_-14px_hsl(var(--sunset-surface2)/0.6)]",
        t.ring,
        className
      )}
      style={
