export function LoadingState({
  ...
  return (
    <div className="rounded-[24px] border border-white/8 bg-[linear-gradient(180deg,rgba(14,5,7,0.72),rgba(10,3,5,0.82))] px-6 py-8 text-center shadow-[0_30px_80px_-38px_rgba(2,0,1,0.75)] backdrop-blur-xl">
