...
const GRADE_STRIP_COLOR_BY_LABEL: Record<string, GradeStripColor> = {
  ...
  "veterano":     { pill: "border-cyan-400/30 bg-cyan-500/10",     dot: "bg-cyan-300",    text: "text-cyan-200" },
  ...
  "soldato":      { pill: "border-yellow-400/30 bg-yellow-500/10", dot: "bg-yellow-300",  text: "text-yellow-200" },
  "novato":       { pill: "border-pink-400/30 bg-pink-500/10",     dot: "bg-pink-300",    text: "text-pink-200" },
